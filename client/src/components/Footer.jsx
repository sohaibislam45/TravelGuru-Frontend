    ...
    <>
      ...
      <footer className="footer backdrop-blur-md bg-base-100/90 border-t border-base-300/50 shadow-sm">
        <div className="container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <nav>
            <h6 className="footer-title text-base font-bold mb-4 text-primary">
              Services
            </h6>
            <a className="link link-hover text-base-content/80 hover:text-primary hover:bg-base-200 transition-colors">
              Vehicle Rental
            </a>
            <a className="link link-hover text-base-content/80 hover:text-primary hover:bg-base-200 transition-colors">
              Trip Planning
